...
class PostSerializer(serializers.HyperlinkedModelSerializer):
    ...
    #comment = serializers.Char(many=True,read_only=True)


    class Meta:
        model = Post
        fields = ('url', 'id', 'highlight', 'owner','image','title', 'content','name','subscribe', 'draft','likes','comment')
'''
class CommentSerializer(serializers.HyperlinkedModelSerializer):
    ...
    class Meta:
        model = Comment
        fields = ('url','id','highlight','owner','post','author')
